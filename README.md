<b>Description:</b> Developed a website to display the IPL 2023 schedule, providing users with an intuitive interface to view match details, dates, and venues.<br>
